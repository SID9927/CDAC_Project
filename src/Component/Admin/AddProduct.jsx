      ...
      <div className="container h-100">
        <div className="row justify-content-sm-center h-100">
          <div className="col-xl-8 col-md-8 col-12 col-sm-12">
            <div className="card shadow-lg my-5 custom-card">
                ...
                <form onSubmit={(e) => addProduct(e)}>
                  <div className="row g-3">
                    <div className="col-xl-6 col-md-6 col-sm-12 col-12 mb-3">
                      <label className="mb-2 text-muted" htmlFor="stockItem">
                        Product Name
                      </label>
                      <input
                        id="stockItem"
                    ...
                    <div className="col-xl-6 col-md-6 col-sm-12 col-12 mb-3">
                      <label className="mb-2 text-muted" htmlFor="quantity">
                        Quantity
                      </label>
                      <input
                        id="quantity"
                  ...
                  <div className="row g-3">
                    <div className="col-xl-6 col-md-6 col-sm-12 col-12 mb-3">
                      <label className="mb-2 text-muted" htmlFor="pricePerUnit">
                        Price Per Unit
                      </label>
                      <input
                        id="pricePerUnit"
                    ...
                    <div className="col-xl-6 col-md-6 col-sm-12 col-12 mb-3">
                      <label className="mb-2 text-muted" htmlFor="categoryData">
                        Select Category
                      </label>
                      <select
