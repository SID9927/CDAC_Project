...
function Register() {
    ...
    return (
        <div style={{
            backgroundImage: "url('https://img.freepik.com/free-photo/business-agreement-shaking-hands-melon-plantation_1150-10603.jpg?t=st=1724228028~exp=1724231628~hmac=770465392bdfa71dae10212ca20e5fe2d95654903ab0f9bcf2e7391805a0a333&w=996')",
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-xl-8">
                        ...
                        <div className="card shadow-lg border " style={{
                            backgroundColor: 'rgba(255, 255, 255, 0.8)',
                            backdropFilter: 'blur(1px)'
                        }}>
                            <div className="card-body px-5 pt-5">
                                <h1 className="fs-4 card-title fw-bold mb-1 text-center text-primary">Sign Up</h1><hr />
