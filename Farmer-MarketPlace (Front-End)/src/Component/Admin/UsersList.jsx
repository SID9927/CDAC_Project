    ...
    <div>
      ...
      <div className="container">
        ...
        <div>
          ...
          <table className="table table-bordered table-striped text-center table-hover custom-table">
            ...
            <tbody>
              {users.map((u) => (
                <tr key={users.indexOf(u)} className="custom-row">
                  <td>{u.userId}</td>
                  <td>{u.firstname}</td>
                  <td>{u.lastname}</td>
                  <td>{u.phoneNo}</td>
                  ...
                  <td>
                    ...
                    <button
                      type="button"
                      className="btn btn-success mx-1 custom-btn"
                      data-bs-toggle="modal"
                      data-bs-target="#exampleModal1"
                      onClick={() => updateUserData(u)}
                    >
                      UPDATE
                    </button>
