...
public partial class FarmersmarketContext : DbContext
{
    public FarmersmarketContext()
    {
    }

    public FarmersmarketContext(DbContextOptions<FarmersmarketContext> options)
        : base(options)
    {
    }
    ...
    //        => optionsBuilder.UseMySql("server=localhost;port=3306;database=farmersmarket;user id=root;password=password", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.1.0-mysql"));
